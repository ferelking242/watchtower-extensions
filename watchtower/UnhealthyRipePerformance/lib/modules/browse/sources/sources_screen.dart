...
class _EmptyState extends StatelessWidget {
  ...
  void _openLocalSource(BuildContext context) {
    final src = Source(name: 'local', lang: '', itemType: itemType);
    switch (itemType) {
      case ItemType.anime:
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OutlinedButton.icon(
                    onPressed: () => _openLocalSource(context),
                    icon: const Icon(Icons.folder_open_rounded, size: 18),
                    label: const Text('Ouvrir source locale'),
                  ),
                ],
              ),
            ),
