...
class Excel {
  ...
  /// Compatibility shim for archive 4.x — accepts raw bytes instead of
  /// the legacy InputStream type that was removed from archive 4.x.
  factory Excel.decodeBuffer(List<int> bytes) {
