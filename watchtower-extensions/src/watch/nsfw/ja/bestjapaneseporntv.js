const watchtowerSources = [{
  "name": "BestJapanesePornTV",
  "lang": "ja",
  "baseUrl": "https://bestjapaneseporntv.com",
  "apiUrl": "",
  "iconUrl": "https://bestjapaneseporntv.com/favicon.ico",
  "typeSource": "single",
  "itemType": 1,
  "version": "1.1.0",
  "pkgPath": "watch/nsfw/ja/bestjapaneseporntv.js",
  "notes": "BestJapanesePornTV — curated Japanese porn streaming",
  "isNsfw": true
}];

const BASE_URL = "https://bestjapaneseporntv.com";

class DefaultExtension extends MProvider {
  getHeaders(url) {
    return {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",
      "Referer": "https://bestjapaneseporntv.com/"
    };
  }
