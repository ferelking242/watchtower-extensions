const watchtowerSources = [{
  "name": "JapanWhores",
  "lang": "ja",
  "baseUrl": "https://www.japanwhores.com",
  "apiUrl": "",
  "iconUrl": "https://www.japanwhores.com/favicon.ico",
  "typeSource": "single",
  "itemType": 1,
  "version": "1.1.0",
  "pkgPath": "watch/nsfw/ja/japanwhores.js",
  "notes": "JapanWhores — free Japanese porn tube",
  "isNsfw": true
}];

const BASE_URL = "https://www.japanwhores.com";

class DefaultExtension extends MProvider {
  getHeaders(url) {
    return {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",
      "Referer": "https://www.japanwhores.com/"
    };
  }
  ...
  _parse(html, base) {
    ...
    const items = [];
    const cards = doc.select(".item, article, .post, [class*='video'], [class*='thumb'], [class*='movie']");
