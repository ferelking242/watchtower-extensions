const watchtowerSources = [{
  "name": "ZeroJav",
  "lang": "ja",
  "baseUrl": "https://zerojav.com",
  "apiUrl": "",
  "iconUrl": "https://zerojav.com/favicon.ico",
  "typeSource": "single",
  "itemType": 1,
  "version": "1.0.2",
  "pkgPath": "zerojav/ja/ja.zerojav.js",
  "notes": "ZeroJav — free JAV streaming, no registration",
  "isNsfw": true
}];

const BASE_URL = "https://zerojav.com";

class DefaultExtension extends MProvider {
  getHeaders(url) {
    return {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",
      "Referer": "https://zerojav.com/"
    };
  }
