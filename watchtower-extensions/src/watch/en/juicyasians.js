const watchtowerSources = [{
  "name": "JuicyAsians",
  "lang": "en",
  "baseUrl": "https://www.juicyasians.com",
  "apiUrl": "",
  "iconUrl": "https://www.google.com/s2/favicons?sz=128&domain=juicyasians.com",
  "typeSource": "single",
  "itemType": 1,
  "version": "1.1.0",
  "pkgPath": "watch/en/juicyasians.js",
  "notes": "JuicyAsians — Asian amateur and professional porn",
  "isNsfw": true
}];

const BASE_URL = "https://www.juicyasians.com";

class DefaultExtension extends MProvider {
  getHeaders(url) {
    return {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",
      "Referer": "https://www.juicyasians.com/"
    };
  }
  ...
  _parse(html, base) {
    ...
    const items = [];
    const cards = doc.select(".item, article, .post, [class*='thumb'], [class*='video']");
