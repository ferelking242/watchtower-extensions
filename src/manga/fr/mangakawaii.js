const watchtowerSources = [{
        ...
        "apiUrl": "https://www.mangakawaii.io",
        "iconUrl": "https://www.mangakawaii.io/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        ...
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Manga Kawaii"
    }];
    const BASE_URL = "https://www.mangakawaii.io";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Manga Kawaii. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
