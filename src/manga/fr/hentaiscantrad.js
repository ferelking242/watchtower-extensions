const watchtowerSources = [{
      ...
      "apiUrl": "https://hentai.scantrad-vf.cc",
      "iconUrl": "https://hentai.scantrad-vf.cc/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/hentaiscantrad.js",
      "editableBaseUrl": true,
      "hasCloudflare": true,
      "requiresAccount": false,
      "hasDRM": false,
      "paywall": "free",
      "notes": "Scans manga FR — Madara/WordPress (NSFW)"
  }];
  const BASE_URL = "https://hentai.scantrad-vf.cc";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Hentai Scantrad. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
