const watchtowerSources = [{
        ...
        "apiUrl": "https://lanortrad.com",
        "iconUrl": "https://lanortrad.com/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/lanortrad.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Lanor Trad"
    }];
    ...
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Lanor Trad. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
