const watchtowerSources = [{
      ...
      "apiUrl": "https://pantheon-scan.com",
      "iconUrl": "https://pantheon-scan.com/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/pantheonscan.js",
  ...
  const BASE_URL = "https://pantheon-scan.com";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Pantheon Scan. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
