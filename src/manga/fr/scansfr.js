const watchtowerSources = [{
        ...
        "apiUrl": "https://scansfr.com",
        "iconUrl": "https://scansfr.com/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        ...
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Scans FR"
    }];
    ...
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Scans FR. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
