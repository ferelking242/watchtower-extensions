const watchtowerSources = [{
      ...
      "apiUrl": "https://mangas-origines.fr",
      "iconUrl": "https://mangas-origines.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/mangasoriginesfr.js",
  ...
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Mangas Origines. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
