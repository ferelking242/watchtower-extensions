const watchtowerSources = [{
        ...
        "apiUrl": "https://phenix-scans.co",
        "iconUrl": "https://phenix-scans.co/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/phenixscansco.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Phenix Scans"
    }];
    const BASE_URL = "https://phenix-scans.co";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Phenix Scans. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
