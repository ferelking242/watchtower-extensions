const watchtowerSources = [{
      ...
      "apiUrl": "https://yaoiscan.fr",
      "iconUrl": "https://yaoiscan.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/yaoiscan.js",
      "editableBaseUrl": true,
      "hasCloudflare": false,
      "requiresAccount": false,
      "hasDRM": false,
      "paywall": "free",
      "notes": "Scans manga FR — MangaThemesia/WordPress (NSFW)"
  }];
  const BASE_URL = "https://yaoiscan.fr";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Yaoi Scan. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
