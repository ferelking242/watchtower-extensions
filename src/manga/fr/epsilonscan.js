const watchtowerSources = [{
        ...
        "apiUrl": "https://epsilonscan.to",
        "iconUrl": "https://epsilonscan.to/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": true,
        "version": "0.1.0",
        "pkgPath": "manga/fr/epsilonscan.js",
    ...
    const BASE_URL = "https://epsilonscan.to";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Epsilon Scan. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
