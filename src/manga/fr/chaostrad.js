const watchtowerSources = [{
        ...
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/chaostrad.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Chaos Trad"
    }];
    ...
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Chaos Trad. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
