const watchtowerSources = [{
        ...
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/perfscan.js",
        "editableBaseUrl": true,
        "hasCloudflare": true,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Perf Scan"
    }];
    const BASE_URL = "https://perf-scan.xyz";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Perf Scan. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
