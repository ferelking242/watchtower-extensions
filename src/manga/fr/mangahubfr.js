const watchtowerSources = [{
      ...
      "apiUrl": "https://mangahub.fr",
      "iconUrl": "https://mangahub.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/mangahubfr.js",
  ...
  const BASE_URL = "https://mangahub.fr";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site MangaHub FR. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
