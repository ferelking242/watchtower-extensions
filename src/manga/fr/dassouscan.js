const watchtowerSources = [{
        ...
        "apiUrl": "https://dassouscan.com",
        "iconUrl": "https://dassouscan.com/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/dassouscan.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Dassou Scan"
    }];
    ...
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Dassou Scan. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
