const watchtowerSources = [{
        ...
        "apiUrl": "https://hentai.scanreader.net",
        "iconUrl": "https://hentai.scanreader.net/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "version": "0.1.0",
        "pkgPath": "manga/fr/hentaiscanreader.js",
    ...
    const BASE_URL = "https://hentai.scanreader.net";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Hentai Scan Reader. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
