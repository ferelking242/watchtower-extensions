const watchtowerSources = [{
        ...
        "apiUrl": "https://bluesolo.org",
        "iconUrl": "https://bluesolo.org/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "version": "0.1.0",
        "pkgPath": "manga/fr/bluesolo.js",
    ...
    const BASE_URL = "https://bluesolo.org";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site BlueSolo. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
