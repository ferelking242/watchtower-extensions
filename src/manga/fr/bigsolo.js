const watchtowerSources = [{
        ...
        "apiUrl": "https://bigsolo.org",
        "iconUrl": "https://bigsolo.org/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/bigsolo.js",
        "editableBaseUrl": true,
        "hasCloudflare": true,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Big Solo"
    }];
    const BASE_URL = "https://bigsolo.org";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Big Solo. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
