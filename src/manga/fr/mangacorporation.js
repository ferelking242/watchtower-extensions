const watchtowerSources = [{
        ...
        "apiUrl": "https://manga-corporation.com",
        "iconUrl": "https://manga-corporation.com/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "version": "0.1.0",
        "pkgPath": "manga/fr/mangacorporation.js",
    ...
    const BASE_URL = "https://manga-corporation.com";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Manga Corporation. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
