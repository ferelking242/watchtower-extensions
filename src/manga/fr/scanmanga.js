const watchtowerSources = [{
        ...
        "apiUrl": "https://m.scan-manga.com",
        "iconUrl": "https://m.scan-manga.com/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/scanmanga.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Scan-Manga"
    }];
    const BASE_URL = "https://m.scan-manga.com";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Scan-Manga. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
