const watchtowerSources = [{
      ...
      "apiUrl": "https://pornhwa.fr",
      "iconUrl": "https://pornhwa.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/pornhwafr.js",
  ...
  const BASE_URL = "https://pornhwa.fr";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Pornhwa FR. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
