const watchtowerSources = [{
      ...
      "apiUrl": "https://hentaizone.xyz",
      "iconUrl": "https://hentaizone.xyz/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/hentaizone.js",
  ...
  const BASE_URL = "https://hentaizone.xyz";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Hentai Zone. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
