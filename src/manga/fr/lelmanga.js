const watchtowerSources = [{
      ...
      "apiUrl": "https://www.lelmanga.com",
      "iconUrl": "https://www.lelmanga.com/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/lelmanga.js",
  ...
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Lel Manga. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
