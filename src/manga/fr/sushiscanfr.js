const watchtowerSources = [{
      ...
      "apiUrl": "https://sushiscan.fr",
      "iconUrl": "https://sushiscan.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/sushiscanfr.js",
  ...
  const BASE_URL = "https://sushiscan.fr";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Sushi Scan FR. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
