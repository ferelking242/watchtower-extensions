const watchtowerSources = [{
        ...
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/raijinscans.js",
        "editableBaseUrl": true,
        "hasCloudflare": true,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Raijin Scans"
    }];
    const BASE_URL = "https://raijin-scans.fr";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Raijin Scans. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
