const watchtowerSources = [{
      ...
      "apiUrl": "https://kiwiyascans.com",
      "iconUrl": "https://kiwiyascans.com/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/kiwiyascans.js",
  ...
  const BASE_URL = "https://kiwiyascans.com";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Kiwiya Scans. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
