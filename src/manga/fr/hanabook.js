const watchtowerSources = [{
        ...
        "apiUrl": "https://www.hana-book.fr",
        "iconUrl": "https://www.hana-book.fr/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/hanabook.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Hana Book"
    }];
    const BASE_URL = "https://www.hana-book.fr";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Hana Book. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
