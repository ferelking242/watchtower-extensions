const watchtowerSources = [{
        ...
        "apiUrl": "https://poseidon-scans.net",
        "iconUrl": "https://poseidon-scans.net/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/poseidonscans.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Poseidon Scans"
    }];
    ...
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Poseidon Scans. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
