const watchtowerSources = [{
        ...
        "apiUrl": "https://scantrad-union.com",
        "iconUrl": "https://scantrad-union.com/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/scantradunion.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Scantrad Union"
    }];
    ...
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Scantrad Union. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
