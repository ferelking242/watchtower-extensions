const watchtowerSources = [{
        ...
        "apiUrl": "https://www.manga-nova.com",
        "iconUrl": "https://www.manga-nova.com/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/manganova.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Manga Nova"
    }];
    const BASE_URL = "https://www.manga-nova.com";
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Manga Nova. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
