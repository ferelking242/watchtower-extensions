const watchtowerSources = [{
        ...
        "apiUrl": "https://www.furyosociety.com",
        "iconUrl": "https://www.furyosociety.com/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/furyosquad.js",
        "editableBaseUrl": true,
        "hasCloudflare": false,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Furyo Squad"
    }];
    ...
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Furyo Squad. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
