const watchtowerSources = [{
      ...
      "apiUrl": "https://harmony-scan.fr",
      "iconUrl": "https://harmony-scan.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/bananascan.js",
  ...
  const BASE_URL = "https://harmony-scan.fr";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Banana Scan. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
