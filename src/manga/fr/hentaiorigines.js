const watchtowerSources = [{
      ...
      "apiUrl": "https://hentai-origines.com",
      "iconUrl": "https://hentai-origines.com/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/hentaiorigines.js",
  ...
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Hentai Origines. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
