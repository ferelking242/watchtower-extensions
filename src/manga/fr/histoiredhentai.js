const watchtowerSources = [{
      "name": "Histoire d'Hentai",
      "langs": ["fr"],
      "ids": { "fr": 678299411 },
      "baseUrl": "https://hhentai.fr",
      "apiUrl": "https://hhentai.fr",
      "iconUrl": "https://hhentai.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
  ...
  const BASE_URL = "https://hhentai.fr";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Histoire d'Hentai. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
