const watchtowerSources = [{
        ...
        "apiUrl": "https://astral-manga.fr",
        "iconUrl": "https://astral-manga.fr/favicon.ico",
        "typeSource": "single",
        "itemType": 2,
        "isManga": true,
        "isNsfw": false,
        "version": "0.1.0",
        "pkgPath": "manga/fr/astralmanga.js",
        "editableBaseUrl": true,
        "hasCloudflare": true,
        "requiresAccount": false,
        "hasDRM": false,
        "paywall": "free",
        "notes": "Scans manga FR (bespoke) — Astral Manga"
    }];
    ...
    class DefaultExtension extends MProvider {
        ...
        getSourcePreferences() {
            return [{
                ...
                editTextPreference: {
                    title: "URL du site",
                    summary: "Adresse du site Astral Manga. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                    value: BASE_URL,
