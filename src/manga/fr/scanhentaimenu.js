const watchtowerSources = [{
      "name": "Scan Hentai Menu",
      "langs": ["fr"],
      "ids": { "fr": 225156168 },
      "baseUrl": "https://x-manga.org",
      "apiUrl": "https://x-manga.org",
      "iconUrl": "https://x-manga.org/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "isManga": true,
      "version": "0.1.0",
      "pkgPath": "manga/fr/scanhentaimenu.js",
  ...
  const BASE_URL = "https://x-manga.org";
  class DefaultExtension extends MProvider {
      ...
      getSourcePreferences() {
        return [{
            ...
            editTextPreference: {
                title: "URL du site",
                summary: "Adresse du site Scan Hentai Menu. Modifiez-la uniquement si le domaine a changé (migration ou miroir).",
                value: BASE_URL,
