const watchtowerSources = [{
    "name": "AnimeOnsen",
    "lang": "en",
    "baseUrl": "https://animeonsen.ru",
    "apiUrl": "https://animeonsen.ru",
    "iconUrl": "https://animeonsen.ru/favicon.ico",
    "typeSource": "single",
    "itemType": 1,
    "version": "0.1.0",
    "pkgPath": "anime/src/en/animeonsen.js",
    "notes": "AnimeOnsen — anime streaming sub",
    "editableBaseUrl": true
}];

const BASE_URL = "https://animeonsen.ru";
...
class DefaultExtension extends MProvider {
    ...
    getSourcePreferences() {
        return [{ key: "base_url", editTextPreference: { title: "Site URL", summary: "Base URL of AnimeOnsen", value: BASE_URL, dialogTitle: "Base URL", dialogMessage: `Current: ${BASE_URL}` } }];
    }
}
