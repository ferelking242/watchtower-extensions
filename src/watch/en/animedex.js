const watchtowerSources = [{
    ...
    "apiUrl": "https://animedex.to",
    "iconUrl": "https://animedex.to/favicon.ico",
    "typeSource": "single",
    "itemType": 1,
    "version": "0.1.0",
    "pkgPath": "anime/src/en/animedex.js",
    "notes": "AnimeDex — anime streaming sub & dub",
    "editableBaseUrl": true
}];

const BASE_URL = "https://animedex.to";
...
class DefaultExtension extends MProvider {
    ...
    getSourcePreferences() {
        return [{ key: "base_url", editTextPreference: { title: "Site URL", summary: "Base URL of AnimeDex", value: BASE_URL, dialogTitle: "Base URL", dialogMessage: `Current: ${BASE_URL}` } }];
    }
}
