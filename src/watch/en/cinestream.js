const watchtowerSources = [{
    "name": "CineStream",
    "lang": "en",
    "baseUrl": "https://cinestream.net",
    "apiUrl": "https://cinestream.net",
    "iconUrl": "https://cinestream.net/favicon.ico",
    "typeSource": "single",
    "itemType": 1,
    "version": "0.1.0",
    "pkgPath": "watch/en/cinestream.js",
    "notes": "CineStream — movie/TV dedicated server",
    "editableBaseUrl": true
}];

const BASE_URL = "https://cinestream.net";
...
class DefaultExtension extends MProvider {
    ...
    async getDetail(url) {
        ...
        const episodes = [];
        const epRe = /<a[^>]+href="(\/[^"]*(?:season|episode|ep)[^"]*)"[^>]*>\s*([^<]+)<\/a>/gi;
        let em;
