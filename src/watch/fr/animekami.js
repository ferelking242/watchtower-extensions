// Anime-Kami — extension Watchtower v1.0.0
// Anime VF/VOSTFR
...
const watchtowerSources = [{
    ...
    "langs": ["fr"],
    "ids": { "fr": 705018273 },
    "baseUrl": "https://anime-kami.com",
    "apiUrl": "https://anime-kami.com",
    "iconUrl": "https://anime-kami.com/favicon.ico",
    "typeSource": "single",
    "itemType": 2,
    "version": "1.1.1",
    "pkgPath": "watch/fr/animekami.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "Anime-Kami — anime-kami.com — VF/VOSTFR."
}];
...
class DefaultExtension extends MProvider {
    ...
    _parseCards(html) {
        ...
        const re = /<a[^>]+href="((?:https?:\/\/[^"]+)?\/(?:anime|film|serie)[^"]+\/)"[^>]*>[\s\S]{0,500}?<img[^>]+(?:src|data-src)="([^"]+)"[^>]+alt="([^"]{2,100})"/gi;
        let m;
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://anime-kami.com",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://anime-kami.com"
                }
            },
            {
                key: "default_quality",
