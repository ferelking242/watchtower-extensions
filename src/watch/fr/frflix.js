// FrFlix — extension Watchtower v1.0.0
// Films & Séries VF — frflix.mov

const watchtowerSources = [{
    "name": "FrFlix",
    "langs": ["fr"],
    "ids": { "fr": 708384756 },
    "baseUrl": "https://frflix.mov",
    "apiUrl": "https://frflix.mov",
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://frflix.mov",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://frflix.mov"
                }
            },
            {
                key: "default_quality",
