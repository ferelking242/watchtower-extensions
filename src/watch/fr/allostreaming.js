// Allostreaming — extension Watchtower v1.0.0
// Films & Séries VF — ww9.allostreaming.one

const watchtowerSources = [{
    "name": "Allostreaming",
    "langs": ["fr"],
    "ids": { "fr": 709475839 },
    "baseUrl": "https://ww9.allostreaming.one",
    "apiUrl": "https://ww9.allostreaming.one",
    "iconUrl": "https://ww9.allostreaming.one/favicon.ico",
    "typeSource": "single",
    "itemType": 1,
    "version": "1.0.1",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "Allostreaming — Films & Séries VF. URL miroir ww9 — modifiable."
}];

const BASE_URL = "https://ww9.allostreaming.one";
