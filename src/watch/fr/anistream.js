// AniStream — extension Watchtower v1.0.0
// Anime VF/VOSTFR — anistream.xyz

const watchtowerSources = [{
    "name": "AniStream",
    "langs": ["fr"],
    "ids": { "fr": 716112586 },
    "baseUrl": "https://anistream.xyz",
    "apiUrl": "https://anistream.xyz",
    "iconUrl": "https://anistream.xyz/favicon.ico",
    "typeSource": "single",
    "itemType": 2,
    "version": "1.1.1",
    "pkgPath": "watch/fr/anistream.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "AniStream — anistream.xyz — VF/VOSTFR."
}];

const BASE_URL = "https://anistream.xyz";
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://anistream.xyz",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://anistream.xyz"
                }
            },
            {
                key: "default_quality",
