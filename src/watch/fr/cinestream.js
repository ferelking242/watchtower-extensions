const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 641839027 },
      "baseUrl": "https://cinestream.io",
      "apiUrl": "https://cinestream.io",
      "iconUrl": "https://cinestream.io/favicon.ico",
      "typeSource": "single",
      "itemType": 1,
      "version": "0.2.3",
      "pkgPath": "watch/fr/cinestream.js",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "Cinestream — domaine cinestream.io hors ligne. Essayer cinestream.cc"
  }];
  const BASE_URL = "https://cinestream.io";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/films/page/{page}/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://cinestream.io",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://cinestream.io"
                }
            },
            {
                key: "default_quality",
