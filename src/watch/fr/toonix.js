const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 274918305 },
      "baseUrl": "https://toonix.fr",
      "apiUrl": "https://toonix.fr",
      "iconUrl": "https://toonix.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "version": "0.2.2",
      "pkgPath": "watch/fr/toonix.js",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "Anime VF enfants/jeunes"
  }];
  const BASE_URL = "https://toonix.fr";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/animes/page/{page}/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://toonix.fr",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://toonix.fr"
                }
            },
            {
                key: "default_quality",
