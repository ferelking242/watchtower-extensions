const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 726491038 },
      "baseUrl": "https://streamay.net",
      "apiUrl": "https://streamay.net",
      "iconUrl": "https://streamay.net/favicon.ico",
      "typeSource": "single",
      "itemType": 1,
      "version": "0.2.3",
      "pkgPath": "watch/fr/streamay.js",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "Streamay — domaine streamay.net hors ligne."
  }];
  const BASE_URL = "https://streamay.net";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/films-vf/page/{page}/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://streamay.net",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://streamay.net"
                }
            },
            {
                key: "default_quality",
