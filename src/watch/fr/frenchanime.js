// French-Anime — extension Watchtower v1.0.0
// Anime VF — french-anime.com
...
const watchtowerSources = [{
    ...
    "itemType": 2,
    "version": "1.1.1",
    "pkgPath": "watch/fr/frenchanime.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "French-Anime — french-anime.com — Anime VF."
}];
...
class DefaultExtension extends MProvider {
    ...
    async getDetail(url) {
        ...
        const chapters = [];
        const epRe = /<a[^>]+href="([^"]*(?:episode|saison|ep)[^"]*)"[^>]*>([\s\S]{0,80}?)<\/a>/gi;
        let em; const eSeen = {};
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    dialogMessage: "URL actuelle : https://french-anime.com"
                }
            },
            {
                key: "default_quality",
