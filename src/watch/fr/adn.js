const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 920384715 },
      "baseUrl": "https://animationdigitalnetwork.fr",
      "apiUrl": "https://animationdigitalnetwork.fr",
      "iconUrl": "https://animationdigitalnetwork.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "version": "0.2.2",
      "pkgPath": "watch/fr/adn.js",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "Animation Digital Network — anime légal FR"
  }];
  const BASE_URL = "https://animationdigitalnetwork.fr";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/catalogue".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
      ...
      async search(query,page,f){const r=await new Client().get(this.baseUrl+"/catalogue?search="+encodeURIComponent(query),this._hdrs());return{list:this._parse(r.body),hasNextPage:false};}
      async getDetail(url){
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://animationdigitalnetwork.fr",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://animationdigitalnetwork.fr"
                }
            },
            {
                key: "default_quality",
