// Noctaflix — extension Watchtower v1.0.0
// Films & Séries VF — noctaflix.lol

const watchtowerSources = [{
    "name": "Noctaflix",
    "langs": ["fr"],
    "ids": { "fr": 707293847 },
    "baseUrl": "https://noctaflix.lol",
    "apiUrl": "https://noctaflix.lol",
    "iconUrl": "https://noctaflix.lol/favicon.ico",
    "typeSource": "single",
    "itemType": 1,
    "version": "1.1.2",
    "pkgPath": "watch/fr/noctaflix.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "Noctaflix — domaine noctaflix.lol hors ligne."
}];
...
class DefaultExtension extends MProvider {
    ...
    _parseCards(html) {
        ...
        const re = /<a[^>]+href="((?:https?:\/\/[^"]+)?\/(?:film|serie|streaming)[^"\/]+[^"]*)"[^>]*>[\s\S]{0,500}?<img[^>]+(?:src|data-src)="([^"]+)"[^>]+alt="([^"]{2,100})"/gi;
        let m;
        ...
        if (items.length === 0) {
            ...
            while ((m2 = re2.exec(html)) !== null) {
                ...
                if (u in seen || !u.includes("noctaflix")) continue; seen[u] = 1;
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://noctaflix.lol",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://noctaflix.lol"
                }
            },
            {
                key: "default_quality",
