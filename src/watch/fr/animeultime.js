const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 508293741 },
      "baseUrl": "https://www.anime-ultime.net",
      "apiUrl": "https://www.anime-ultime.net",
      "iconUrl": "https://www.anime-ultime.net/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "version": "0.2.2",
      "pkgPath": "watch/fr/animeultime.js",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "Anime VOSTFR historique"
  }];
  const BASE_URL = "https://www.anime-ultime.net";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/animes/liste/page/{page}".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
      ...
      async search(query,page,f){const r=await new Client().get(this.baseUrl+"/search/?k="+encodeURIComponent(query),this._hdrs());return{list:this._parse(r.body),hasNextPage:false};}
      async getDetail(url){
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://www.anime-ultime.net",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://www.anime-ultime.net"
                }
            },
            {
                key: "default_quality",
