const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 847291503 },
      "baseUrl": "https://animeko.co",
      "apiUrl": "https://animeko.co",
      "iconUrl": "https://animeko.co/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "version": "0.2.2",
      "pkgPath": "watch/fr/animeko.js",
  ...
  const BASE_URL = "https://animeko.co";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/anime/page/{page}/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://animeko.co",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://animeko.co"
                }
            },
            {
                key: "default_quality",
