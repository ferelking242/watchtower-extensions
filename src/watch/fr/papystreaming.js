const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 372918045 },
      "baseUrl": "https://papystreaming.sh",
      "apiUrl": "https://papystreaming.sh",
      "iconUrl": "https://papystreaming.sh/favicon.ico",
      "typeSource": "single",
      "itemType": 1,
      "version": "0.2.3",
      "pkgPath": "watch/fr/papystreaming.js",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "Papystreaming — domaine papystreaming.sh hors ligne."
  }];
  const BASE_URL = "https://papystreaming.sh";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/films-streaming/page/{page}/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://papystreaming.sh",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://papystreaming.sh"
                }
            },
            {
                key: "default_quality",
