// JetAnimes — extension Watchtower v1.0.0
// Anime VF/VOSTFR — jetanimes.co

const watchtowerSources = [{
    "name": "JetAnimes",
    "langs": ["fr"],
    "ids": { "fr": 713839253 },
    "baseUrl": "https://jetanimes.co",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "JetAnimes — jetanimes.co — VF/VOSTFR."
}];

const BASE_URL = "https://jetanimes.co";
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://jetanimes.co",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://jetanimes.co"
                }
            },
            {
                key: "default_quality",
