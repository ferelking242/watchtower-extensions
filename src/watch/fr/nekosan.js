const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 675293018 },
      "baseUrl": "https://neko-san.fr",
      "apiUrl": "https://neko-san.fr",
      "iconUrl": "https://neko-san.fr/favicon.ico",
      "typeSource": "single",
      "itemType": 2,
      "version": "0.2.2",
      "pkgPath": "watch/fr/nekosan.js",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "Anime VF/VOSTFR"
  }];
  const BASE_URL = "https://neko-san.fr";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/anime-vf-vostfr/page/{page}/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://neko-san.fr",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://neko-san.fr"
                }
            },
            {
                key: "default_quality",
