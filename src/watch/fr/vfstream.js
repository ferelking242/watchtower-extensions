// VFStream — extension Watchtower v1.0.0
// Films VF en streaming — films.vfstream.eu

const watchtowerSources = [{
    "name": "VFStream",
    "langs": ["fr"],
    "ids": { "fr": 706127384 },
    "baseUrl": "https://films.vfstream.eu",
    "apiUrl": "https://films.vfstream.eu",
...
class DefaultExtension extends MProvider {
    ...
    async getLatestUpdates(page) {
        const url = page <= 1 ? this.baseUrl + "/nouveautes/" : `${this.baseUrl}/nouveautes/page/${page}/`;
        const res = await new Client().get(url, this._hdrs());
        const items = this._parseCards(res.body);
        return { list: items, hasNextPage: items.length >= 8 };
    }
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://films.vfstream.eu",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://films.vfstream.eu"
                }
            },
            {
                key: "default_quality",
