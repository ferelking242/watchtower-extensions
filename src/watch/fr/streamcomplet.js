const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 703849162 },
      "baseUrl": "https://www.streamcomplet.blue",
      "apiUrl": "https://www.streamcomplet.blue",
  ...
  const BASE_URL = "https://www.streamcomplet.blue";
  class DefaultExtension extends MProvider {
      ...
      _parse(html){
          ...
          while((m=re.exec(html))!==null){
              ...
              if(url in seen||url===this.baseUrl||url===this.baseUrl+"/")continue;
              seen[url]=1;list.push({link:url,imageUrl:m[2],name:this._decode(m[3].trim())});
          }
          return list;
      }
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/films-vf-vostfr/page/"+page,this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://www.streamcomplet.blue",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://www.streamcomplet.blue"
                }
            },
            {
                key: "default_quality",
