const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 391827045 },
      "baseUrl": "https://www.mangas.io",
      "apiUrl": "https://www.mangas.io",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "Manga lecture en ligne"
  }];
  const BASE_URL = "https://www.mangas.io";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
      ...
      async search(query,page,f){const r=await new Client().get(this.baseUrl+"/?q="+encodeURIComponent(query),this._hdrs());return{list:this._parse(r.body),hasNextPage:false};}
      async getDetail(url){
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://www.mangas.io",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://www.mangas.io"
                }
            },
            {
                key: "default_quality",
