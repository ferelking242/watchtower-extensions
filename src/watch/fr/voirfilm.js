const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 693820147 },
      "baseUrl": "https://voirfilm.pe",
      "apiUrl": "https://voirfilm.pe",
      "iconUrl": "https://voirfilm.pe/favicon.ico",
      "typeSource": "single",
      "itemType": 1,
      "version": "0.2.3",
      "pkgPath": "watch/fr/voirfilm.js",
      ...
      "hasDRM": false,
      "paywall": "free",
      "notes": "VoirFilm — domaine voirfilm.pe hors ligne."
  }];
  const BASE_URL = "https://voirfilm.pe";
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/films-en-streaming/page/{page}/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://voirfilm.pe",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://voirfilm.pe"
                }
            },
            {
                key: "default_quality",
