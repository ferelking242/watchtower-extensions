// Enma — extension Watchtower v1.0.0
// Anime VF/VOSTFR — enma.fr

const watchtowerSources = [{
    "name": "Enma",
    "langs": ["fr"],
    "ids": { "fr": 732568362 },
    "baseUrl": "https://enma.fr",
    "apiUrl": "https://enma.fr",
    "iconUrl": "https://enma.fr/favicon.ico",
    "typeSource": "single",
    "itemType": 2,
    "version": "1.1.1",
    "pkgPath": "watch/fr/enma.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "Enma — enma.fr — Anime VF/VOSTFR."
}];

const BASE_URL = "https://enma.fr";
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    dialogMessage: "URL actuelle : https://enma.fr"
                }
            },
            {
                key: "default_quality",
