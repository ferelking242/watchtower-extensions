const watchtowerSources = [{
      ...
      "langs": ["fr"],
      "ids": { "fr": 837401592 },
      "baseUrl": "https://www.zone-telechargement.com",
      "apiUrl": "https://www.zone-telechargement.com",
  ...
  class DefaultExtension extends MProvider {
      ...
      async getPopular(page){const r=await new Client().get(this.baseUrl+"/film/page/{page}/".replace("{page}",page),this._hdrs());return{list:this._parse(r.body),hasNextPage:page<20};}
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://www.zone-telechargement.com",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://www.zone-telechargement.com"
                }
            },
            {
                key: "default_quality",
