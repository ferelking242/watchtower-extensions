// Plutonflix — extension Watchtower v1.0.0
// Films & Séries VF — plutonflix.org

const watchtowerSources = [{
    "name": "Plutonflix",
    "langs": ["fr"],
    "ids": { "fr": 726022696 },
    "baseUrl": "https://plutonflix.org",
    "apiUrl": "https://plutonflix.org",
    "iconUrl": "https://plutonflix.org/favicon.ico",
    "typeSource": "single",
    "itemType": 1,
    "version": "1.1.2",
    "pkgPath": "watch/fr/plutonflix.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "Plutonflix — domaine plutonflix.org hors ligne."
}];

const BASE_URL = "https://plutonflix.org";
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://plutonflix.org",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://plutonflix.org"
                }
            },
            {
                key: "default_quality",
