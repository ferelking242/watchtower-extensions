// AnimeSite — extension Watchtower v1.0.0
// Anime VF/VOSTFR — animesite.fr

const watchtowerSources = [{
    "name": "AnimeSite",
    "langs": ["fr"],
    "ids": { "fr": 733659473 },
    "baseUrl": "https://animesite.fr",
    "apiUrl": "https://animesite.fr",
    "iconUrl": "https://animesite.fr/favicon.ico",
    "typeSource": "single",
    "itemType": 2,
    "version": "1.1.1",
    "pkgPath": "watch/fr/animesite.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "AnimeSite — animesite.fr — VF/VOSTFR."
}];

const BASE_URL = "https://animesite.fr";
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://animesite.fr",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://animesite.fr"
                }
            },
            {
                key: "default_quality",
