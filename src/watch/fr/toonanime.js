// ToonAnime — extension Watchtower v1.0.0
// Anime VF/VOSTFR — v8.toonanime.co

const watchtowerSources = [{
    "name": "ToonAnime",
    "langs": ["fr"],
    "ids": { "fr": 711657031 },
    "baseUrl": "https://v8.toonanime.co",
    "apiUrl": "https://v8.toonanime.co",
    "iconUrl": "https://v8.toonanime.co/favicon.ico",
    "typeSource": "single",
    "itemType": 2,
    "version": "1.1.1",
    "pkgPath": "watch/fr/toonanime.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "ToonAnime — v8.toonanime.co — VF/VOSTFR. URL miroir modifiable."
}];

const BASE_URL = "https://v8.toonanime.co";
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://v8.toonanime.co",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://v8.toonanime.co"
                }
            },
            {
                key: "default_quality",
