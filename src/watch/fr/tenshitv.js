// TenshiTV — extension Watchtower v1.0.0
// Anime VF/VOSTFR — tenshi.tv

const watchtowerSources = [{
    "name": "TenshiTV",
    "langs": ["fr"],
    "ids": { "fr": 717203697 },
    "baseUrl": "https://tenshi.tv",
    "apiUrl": "https://tenshi.tv",
    "iconUrl": "https://tenshi.tv/favicon.ico",
    "typeSource": "single",
    "itemType": 2,
    "version": "1.1.1",
    "pkgPath": "watch/fr/tenshitv.js",
    ...
    "isAggregator": false,
    "paywall": "free",
    "notes": "TenshiTV — tenshi.tv — VF/VOSTFR."
}];

const BASE_URL = "https://tenshi.tv";
        ...
        return [
            {
                ...
                editTextPreference: {
                    ...
                    value: "https://tenshi.tv",
                    dialogTitle: "URL du site",
                    dialogMessage: "URL actuelle : https://tenshi.tv"
                }
            },
            {
                key: "default_quality",
