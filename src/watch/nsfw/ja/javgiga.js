const watchtowerSources = [{
  "name": "JAVGiga",
  "lang": "ja",
  "baseUrl": "https://javgiga.com",
  "apiUrl": "",
  "iconUrl": "https://javgiga.com/favicon.ico",
  "typeSource": "single",
  "itemType": 1,
  "version": "1.0.1",
  "pkgPath": "javgiga/ja/ja.javgiga.js",
  "notes": "JAVGiga — free JAV streaming online",
  "isNsfw": true
}];

const BASE_URL = "https://javgiga.com";
...
class DefaultExtension extends MProvider {
  ...
  _parse(html, base) {
    ...
    for (const card of cards) {
      const a = card.selectFirst("h2 a, h3 a, a[href*='javgiga'], a");
      if (!a) continue;
