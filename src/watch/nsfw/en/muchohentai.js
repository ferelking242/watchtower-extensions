const watchtowerSources = [{
  ...
  "apiUrl": "",
  "iconUrl": "https://muchohentai.com/favicon.ico",
  "typeSource": "single",
  "itemType": 1,
  "version": "1.0.0",
  "pkgPath": "watch/nsfw/en/muchohentai.js",
  "notes": "MuchoHentai streaming — also ES/multi (18+)",
  "isNsfw": true
}];

const BASE = "https://muchohentai.com";
...
class DefaultExtension extends MProvider {
  ...
  async getPopular(page) {
    const res = await new Client().get(`${BASE}/?page=${page}&orderby=popular`, this.getHeaders());
