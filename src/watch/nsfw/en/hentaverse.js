const watchtowerSources = [{
  ...
  "apiUrl": "",
  "iconUrl": "https://hentaverse.com/favicon.ico",
  "typeSource": "single",
  "itemType": 1,
  "version": "1.0.0",
  "pkgPath": "watch/nsfw/en/hentaverse.js",
  "notes": "Hentaverse streaming (18+)",
  "isNsfw": true
}];

const BASE = "https://hentaverse.com";
...
class DefaultExtension extends MProvider {
  ...
  _parse(html) {
    ...
    const items = [];
    const seen = new Set();
    for (const card of doc.select("article,.video-item,.episode-item,[class*=video],[class*=episode]")) {
      ...
      const name = card.selectFirst("h1,h2,h3,.title")?.text?.trim() || a.attr("title") || "Episode";
