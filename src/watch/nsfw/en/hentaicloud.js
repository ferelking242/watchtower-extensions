const watchtowerSources = [{
  "name": "HentaiCloud",
  "lang": "en",
  "baseUrl": "https://hentaicloud.com",
  "apiUrl": "",
  "iconUrl": "https://hentaicloud.com/favicon.ico",
  "typeSource": "single",
  "itemType": 1,
  "version": "1.0.0",
  "pkgPath": "watch/nsfw/en/hentaicloud.js",
  "notes": "HentaiCloud streaming (18+)",
  "isNsfw": true
}];

const BASE = "https://hentaicloud.com";
...
class DefaultExtension extends MProvider {
  ...
  _parse(html) {
    ...
    for (const card of doc.select("article,.video-item,.item,.anime-item")) {
      ...
      const name = card.selectFirst("h2,h3,.title")?.text?.trim() || a.attr("title") || "Hentai";
