const watchtowerSources = [{
    "name": "Playary",
    "lang": "multi",
    "baseUrl": "https://playary.com",
    "apiUrl": "https://playary.com",
    "iconUrl": "https://playary.com/favicon.ico",
    "typeSource": "single",
    "itemType": 1,
    "version": "0.1.0",
    "pkgPath": "watch/multi/playary.js",
    "notes": "Playary — free movies & TV streaming",
    "editableBaseUrl": true
}];

const BASE_URL = "https://playary.com";
...
class DefaultExtension extends MProvider {
    ...
    async getVideoList(url) {
        const fullUrl = url.startsWith("http") ? url : `${this.getBaseUrl()}${url}`;
        return [{ url: fullUrl, quality: "Playary", originalUrl: fullUrl }];
    }
